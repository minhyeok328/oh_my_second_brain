...
[[SKN26 2차 프로젝트 - 카드 이탈 예측]]은 Docker Compose로 Streamlit dashboard, MLflow, pipeline API, DB를 함께 실행하도록 README에 안내한다. 서비스 접속 포트는 Streamlit, MLflow, Pipeline API가 분리되어 있다.
