...
[[SKN26 3차 프로젝트 - PICKLE RAG 챗봇]]은 category, food, menu, tag, review별 embedding을 만들고 SQLite에 base64 TEXT로 저장했다. [[SKN26 4차 프로젝트 - LG Home]]은 OpenAI embedding으로 사용설명서 query vector를 만들고 Pinecone에서 제품군별 chunk를 찾았다.
