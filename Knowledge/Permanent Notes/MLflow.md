...
[[SKN26 2차 프로젝트 - 카드 이탈 예측]]의 `load_latest_model_by_name.py`는 experiment와 model name을 기준으로 최신 run을 찾고, 모델 flavor에 따라 `mlflow.sklearn`, `mlflow.lightgbm`, `mlflow.pyfunc` loader를 선택한다.
