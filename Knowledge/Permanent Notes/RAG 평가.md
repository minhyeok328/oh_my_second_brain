...
[[SKN26 3차 프로젝트 - PICKLE RAG 챗봇]]의 `src_test3\evaluate_llm.py`는 route 30%, payload 25%, target 25%, answer 10%, retrieval 10% 가중치로 케이스별 점수를 계산한다. goldset은 `fixed 20개 + embedding 30개`로 구성된다.
