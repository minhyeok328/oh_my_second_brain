...
[[SKN26 3차 PICKLE 맛집 추천 챗봇]]은 별도 vector DB 대신 SQLite에 base64 embedding을 저장하고 런타임에 유사도를 계산했다. [[SKN26 4차 LG Home AI 가전 상담]]은 Pinecone `user_manual` namespace에 매뉴얼 chunk와 `product_code_header` metadata를 저장해 제품군별로 검색했다.
