...
- [[SKN26 3차 PICKLE 맛집 추천 챗봇]]은 SQLite의 식당·메뉴·리뷰·태그 데이터를 검색하고, 후보 식당 dict 안에서만 답하도록 제한했다.
- [[SKN26 4차 LG Home AI 가전 상담]]은 Pinecone `user_manual` namespace에서 제품군별 매뉴얼 chunk를 검색해 제품 사용법과 오류 해결 답변에 사용했다.
